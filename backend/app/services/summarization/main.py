...
from app.services.summarization.summarization import summarize
...
async def main():
    ...
    ner_service_worker_manager = ServiceWorkerManager(service_name="summarization_service",
                                                      event_bus=event_bus,
                                                      job_store=job_store,
                                                      executor=executor,
                                                      process_fn=summarize)
