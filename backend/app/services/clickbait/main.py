...
from app.services.clickbait.clickbait import detect_clickbait
...
async def main():
    ...
    ner_service_worker_manager = ServiceWorkerManager(service_name="clickbait_service",
                                                      event_bus=event_bus,
                                                      job_store=job_store,
                                                      executor=executor,
                                                      process_fn=detect_clickbait)
