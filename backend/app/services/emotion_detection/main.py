...
from app.services.emotion_detection.emotion_detection import detect_emotions
...
async def main():
    ...
    ner_service_worker_manager = ServiceWorkerManager(service_name="ed_service",
                                                      event_bus=event_bus,
                                                      job_store=job_store,
                                                      executor=executor,
                                                      process_fn=detect_emotions)
