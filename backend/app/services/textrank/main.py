...
from app.services.textrank.textrank import process_textrank
...
async def main():
    ...
    ner_service_worker_manager = ServiceWorkerManager(service_name="textrank_service",
                                                      event_bus=event_bus,
                                                      job_store=job_store,
                                                      executor=executor,
                                                      process_fn=process_textrank)
